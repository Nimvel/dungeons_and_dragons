...
{/* ===================================CreateMapChapter===================================== */}
        ...
        <img className={s.arrow_2} src={arrows[2]} />
            <div className={`${s.border} ${s.createMapMenuChapter}`}>
        ...
        {isCreateMapDimentionsChapter && <div className={`${s.border} ${s.createMapDimentionsChapter}`}>
        ...
        <img className={s.arrow_3} src={arrows[3]} />
            <div className={`${s.border} ${s.сreateMapItemsChapter}`}>
        ...
        {isCreateMapMoveItemsChapter && <div className={`${s.border} ${s.createMapMoveItemsChapter}`}>
            <p>If you don't want the tree to stand exactly in the cell, 
                then click again on the same icon in the menu to deselect it (it's marked with a red border). 
                Then, click and hold on a tree on the map to drag it where you want it.</p>
        </div>}
        {isCreateMapFreeButtonChapter && <>
        <img className={s.arrow_5_small} src={smallArrows[4]} />
        <img className={s.arrow_5} src={arrows[5]} />
            <div className={`${s.border} ${s.createMapFreeButtonChapter}`}>
                <p>The "free" button is responsible for the ability to move elements not evenly across the cells. 
                    Click on this button and now try to move the tree.</p>
            </div></>}
        {isCreateMapFixButtonChapter && <>
            <img className={s.arrow_6_small} src={smallArrows[5]} />
            <img className={s.arrow_6} src={arrows[6]} />
            <div className={`${s.border} ${s.сreateMapItemsChapter}`}>
                <p>When you have completed the map, you can click on the "fix" button so that you don't accidentally move anything.</p>
            </div></>}
...
{/* ===================================DiceChapter===================================== */}
        ...
        {isDiceMenuChapter && <>
            <img className={s.arrow_7_small} src={smallArrows[1]} />
            <img className={s.arrow_7} src={arrows[7]} />
            <div className={`${s.border} ${s.diceChapter}`}>
...
{/* ===================================PaintChapter===================================== */}
        ...
        {isChangeColorLineChapter && <>
            <img className={s.arrow_8_small} src={smallArrows[6]} />
            <img className={s.arrow_8} src={arrows[10]} />
            <div className={`${s.border} ${s.changeColorLineChapter}`}>
...
{/* ===================================EndChapter===================================== */}
        ...
        {isEndChapter && <div className={s.EndChapter}>
            ...
            <img src={icons[0]} className={s.firework_1} />
