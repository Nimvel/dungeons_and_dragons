...
const Education: FC<EducationProps> = ({ isIntroduction, isNavbarChapter, isNavbarIconsChapter, isMapMenuChapter,
    ...
    return <div className={s.education}>
        ...
        {isNavbarChapter && <div className={s.navbarChapter} > Click here to open the menu </div>}
        {isNavbarIconsChapter && <div className={s.navbarIconsChapter} >
        ...
        {isCreateMapMenuChapter && <div className={s.createMapChapter}>
        ...
        {isCreateMapFillChapter && <div className={s.createMapChapter}>
        Let's fill the whole map with grass. To do this, double-click on the grass icon (or any other).
            </div>}
        {isCreateMapItemsChapter && <div className={s.createMapChapter}>
        ...
        {isCreateMapFreeButtonChapter && <div className={s.createMapChapter}>
        ...
        {isCreateMapFixButtonChapter && <div className={s.createMapChapter}>
        ...
        {isDiceMenuChapter && <div className={s.navbarIconsChapter}>
        ...
        {isAllDiceMenuChapter && <div className={s.navbarIconsChapter}>
        Click on any dice to get a random value.
            </div>}
        {isChangeDiceMenuChapter && <div className={s.changeDiceChapter}>
        ...
        {isPaintMenuChapter && <div className={s.navbarIconsChapter}>
        ...
        {isChangeColorLineChapter && <div className={s.navbarIconsChapter}>
        ...
        <button className='button_off' onClick={onEndClick}>Yes</button>
            </div>}
    </div>
}
