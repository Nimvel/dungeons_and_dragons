    ...
    switch (action.type) {
        ...
        case ADD_NEW_BACKGROUND_ITEM:
            let item = {
                ...
                x: 0,
                y: 0,
                id: state.backgroundItemsOnMap.length
            }
            return {
                ...state,
...
type ActionsTypes = SetNewMapType | CleanMapType | UpdateMapDimensionsType | AddNewBackgroundItemOnMapType | AddNewCircleType | UpdateItemsType
